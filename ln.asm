   ...
   f:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  27:	89 14 24             	mov    %edx,(%esp)
  2a:	e8 a3 02 00 00       	call   2d2 <exit>
  ...
  3b:	e8 f2 02 00 00       	call   332 <link>
  40:	83 c4 10             	add    $0x10,%esp
  43:	85 c0                	test   %eax,%eax
  45:	78 16                	js     5d <main+0x5d>
  ...
  5c:	c3                   	ret
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
  5d:	ff 73 08             	push   0x8(%ebx)
  60:	ff 73 04             	push   0x4(%ebx)
  63:	68 7b 07 00 00       	push   $0x77b
  68:	6a 02                	push   $0x2
  6a:	e8 f1 03 00 00       	call   460 <printf>
  6f:	83 c4 10             	add    $0x10,%esp
  72:	eb d3                	jmp    47 <main+0x47>
  74:	66 90                	xchg   %ax,%ax
  76:	66 90                	xchg   %ax,%ax
  78:	66 90                	xchg   %ax,%ax
  7a:	66 90                	xchg   %ax,%ax
 ...
 469:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 5e0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5e5:	bb 8f 07 00 00       	mov    $0x78f,%ebx
